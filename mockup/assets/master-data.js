...
const VALIDATIONS = [
  { sev: 'block', title: 'คณะที่ยังไม่มีค่าเสื่อมราคาอาคาร', n: 20, unit: 'คณะ/วิทยาลัย', impact: 'TFC ต่ำกว่าจริงทั้งระบบ · ส่วนเกิน +32.8 ลบ. สูงเกินจริง', owner: 'กองคลัง — งานบริหารสินทรัพย์', go: 'W13-exceptions.html' },
...
const SETTINGS = [
  ...
  { key: 'default_revenue_mode', grp: 'calculation', name: 'ฐานรายได้ตั้งต้นของรายงาน',
    ...
    impact: {
      with_government: 'เห็นภาพตามงบที่ได้รับจริงทั้งหมด — ส่วนเกิน <b>+32.8 ลบ.</b>',
  ...
  { key: 'amount_basis', grp: 'allocation', name: 'ฐานจำนวนเงินที่ใช้เป็นต้นทุนหลัก',
    ...
    impact: {
      ACTUAL: 'ต้นทุนรวม <b>2,415.8 ลบ.</b> — สะท้อนสิ่งที่เกิดขึ้นจริง เหมาะกับการรายงานย้อนหลัง',
      BUDGET: 'ต้นทุนรวม <b>2,502.1 ลบ.</b> — สะท้อนกรอบที่ได้รับจัดสรร เหมาะกับการวางแผนปีถัดไป · ส่วนเกินจะกลายเป็น <b>−53.5 ลบ.</b>',
    } },
  ...
  { key: 'non_academic_unit_in_total', grp: 'presentation', name: 'นับหน่วยที่ไม่ผลิตบัณฑิตในยอดรวมหรือไม่',
    ...
    impact: {
      true: 'รวมทุกหน่วย — ส่วนเกินมหาวิทยาลัย <b>+32.8 ลบ.</b>',
