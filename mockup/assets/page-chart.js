...
function chRecommend(o,name,r,avc,qs,sur,s){
  ...
  E.push({t:'warn',h:`ใช้ตัวเลข "<b>ไม่รวมเงินแผ่นดิน</b>" เป็นเกณฑ์ความยั่งยืนระยะยาว และเตรียมแผนรองรับกรณีถูกปรับลดงบอุดหนุน (ทั้งมหาวิทยาลัยกำไร +32.8 ลบ. เมื่อรวมเงินแผ่นดิน แต่ขาดทุนหากตัดงบส่วนนี้)`});
