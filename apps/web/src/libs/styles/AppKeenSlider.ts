...
// Third-party Imports
// NOTE: `keen-slider` is not a dependency of apps/web — this component is unused reference
// material from the template; install `keen-slider` before wiring it into a real page.
