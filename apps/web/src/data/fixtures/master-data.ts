/**
 * ข้อมูลจำลองของหน้าจอที่ prototype v8-1 ยังไม่มี (W8, W9, W11–W19)
 *
 * ย้ายมาจาก mockup/assets/master-data.js ตรงตัว — โครงสร้างทุกก้อนอ้างอิงตารางจริงใน
 * db/01_schema.sql ตามที่ระบุใน SA.md §5 ตัวเลขเงินมาจากชุดข้อมูลที่โหลดอยู่ (RAW)
 * ส่วนชื่อคนและเวลาเป็นตัวอย่าง
 *
 * หน้าจอต้องอ่านผ่าน src/server/beps/* ไม่ใช่ import ไฟล์นี้ตรงๆ (ดูแผน Phase 2/4)
 */
import { RAW } from './raw'
...
const _mb = (v: number) => (v / 1e6).toLocaleString('th-TH', { minimumFractionDigits: 1, maximumFractionDigits: 1 })
...
const _surBias =
  _sur >= 0 ? `ส่วนเกิน ${_surTxt} สูงเกินจริง` : `ตัวเลขขาดทุน ${_mb(Math.abs(_sur))} ลบ. น้อยกว่าความจริง`
...
export const FEE_LOG = [
  ...
  { t: '18 มี.ค. 2568 16:40', ic: '📤', h: '<b>กองแผนงาน</b> เสนออนุมัติ — ปรับจาก 34,000 เป็น 36,000 บาท (+5.9%)' },
  {
    ...
    ic: '📝',
    h: '<b>นางสาวสิริมา ศรีสุภาพ</b> แก้ไขร่าง แนบมติที่ประชุมคณะ ครั้งที่ 3/2568'
  },
...
export const VALIDATIONS = [
  {
    ...
    n: 20,
    unit: 'คณะ/วิทยาลัย',
    impact: `TFC ต่ำกว่าจริงทั้งระบบ · ${_surBias}`,
    owner: 'กองคลัง — งานบริหารสินทรัพย์',
    go: 'W13-exceptions.html'
  },
  {
    sev: 'block',
...
export const RUN_FLOW = ['DRAFT', 'RUNNING', 'CALCULATED', 'VALIDATED', 'APPROVED']

export const RUN_LOG = [
  {
    t: '11 ก.ค. 2569 14:32',
    ic: '✅',
    h: '<b>ผศ.ดร.ปิยภัทร บุษบาบดินทร์</b> อนุมัติรอบคำนวณ — ผลชุดนี้กลายเป็นตัวเลขอ้างอิงของปีงบ 2568'
  },
  ...
  { t: '11 ก.ค. 2569 14:01', ic: '⚙️', h: 'คำนวณเสร็จ 230 หลักสูตร × 2 ฐานรายได้ × 3 ระดับ ใช้เวลา 4 นาที 12 วินาที' },
  {
    t: '11 ก.ค. 2569 13:57',
    ic: '🚩',
    h: 'พบรายการค้างตรวจ <b>8 รายการ</b> มูลค่ารวม 9.4 ลบ. (0.39% ของต้นทุนรวม) — บันทึกไว้ ไม่ปิดกั้นการคำนวณ'
  },
  {
    t: '11 ก.ค. 2569 13:56',
    ic: '▶️',
    h: '<b>นางสาวสิริมา ศรีสุภาพ</b> สั่งเริ่มคำนวณ — ล็อกกติกาผังบัญชี v3 · ฐานต้นทุน ACTUAL'
  }
]
...
export const RECON_METHODS = [
  {
    l: 'ผูกหลักสูตรโดยตรง (DIRECT)',
    v: RAW.UNI.TC - _allocTot,
    c: '#0ca678',
    alloc: false,
    note: 'ต้นทุนที่ระบุหลักสูตรได้จากเอกสารต้นทาง'
  },
  {
    l: 'ตามการใช้จริง (ACTUAL_USAGE)',
    v: _allocTot * 0.086,
    c: '#6d4cff',
    alloc: true,
  ...
  {
    l: 'ตามจำนวนนิสิต (STUDENT_HEADCOUNT)',
    v: _allocTot * 0.871,
    c: '#f59f00',
    alloc: true,
  ...
  {
    l: 'ตามสัดส่วนหลักสูตร (PROGRAM_SHARE)',
    v: _allocTot * 0.043,
    c: '#e64980',
    alloc: true,
...
export const EXCEPTIONS = [
  {
    ...
    since: '11 ก.ค. 2569',
    state: 'OPEN',
    note: `ยังไม่เชื่อมต่อระบบสินทรัพย์ส่วนอาคาร · TFC และ TC ต่ำกว่าจริง ${_surBias} และ Q* ทุกระดับต่ำกว่าที่ควรเป็น`
  },
  {
    flag: 'UNCLASSIFIED',
    label: 'ยังไม่จำแนก',
...
export const ACCOUNTS = [
  ...
  },
  {
    ...
    org: null,
    amount: 87200000,
    rules: [{ from: 2500, to: null, beh: 'FIXED', f: 1, v: 0, m: 'STUDENT_HEADCOUNT', note: '' }]
  },
  {
    key: '2 · 2 · 410 · 41001',
    name: 'ค่าสาธารณูปโภค',
  ...
  },
  {
    ...
    org: null,
    amount: 58700000,
    rules: [{ from: 2500, to: null, beh: 'FIXED', f: 1, v: 0, m: 'PROGRAM_SHARE', note: '' }]
  },
  {
    key: '— · — · — · DEP',
...
export const SETTINGS = [
  {
    ...
    impact: {
      ...
      pooled:
        'Q* มหาวิทยาลัย = <b>47,644 คน</b> · ยอมให้หลักสูตรที่กำไรอุ้มหลักสูตรที่ขาดทุน — <b>ต่างจากอีกวิธี 5,441 คน</b>'
    }
  },
  {
    ...
    impact: {
      full_cost_recovery:
        '<b>18 หลักสูตร</b> จะแสดงเป้าหมายขั้นต่ำเป็นตัวเลข เช่น เคมี (ป.โท) = <b>24 คน</b> — ผู้ใช้อาจเข้าใจผิดว่าเป็นจุดคุ้มทุนจริง',
      not_computable:
        '<b>18 หลักสูตร</b> จะแสดงว่า "ไม่มีจุดคุ้มทุน" ตรงไปตรงมา — ต้องแก้ที่ค่าธรรมเนียมหรือต้นทุนผันแปร ไม่ใช่เพิ่มนิสิต'
    }
  },
  {
    key: 'qstar_rounding',
  ...
  {
    key: 'default_revenue_mode',
    grp: 'calculation',
    name: 'ฐานรายได้ตั้งต้นของรายงาน',
    desc: 'ระบบคำนวณทั้งสองฐานเสมอ ค่านี้กำหนดว่าเปิดหน้าจอมาแล้วเห็นฐานไหนก่อน',
    type: 'enum',
    opts: ['with_government', 'without_government'],
    def: 'with_government',
    cur: null,
    affects: false,
    impact: {
  ...
  },
  {
    ...
    grp: 'allocation',
    name: 'วิธีปันส่วนเมื่อกติกาไม่ได้ระบุ',
    desc: 'ใช้เมื่อกติกาใน W14 ไม่ได้กำหนดวิธีปันส่วนไว้',
    type: 'enum',
    opts: ['STUDENT_HEADCOUNT', 'PROGRAM_SHARE', 'ACTUAL_USAGE'],
    def: 'STUDENT_HEADCOUNT',
    cur: null,
    affects: true,
    impact: {
      STUDENT_HEADCOUNT: 'ปันตามจำนวนนิสิต — ตรงไปตรงมาและอธิบายง่ายที่สุด',
      PROGRAM_SHARE:
        'ปันเท่าๆ กันรายหลักสูตร — <b>หลักสูตรเล็กจะรับภาระสูงผิดปกติ</b> (ต้นเหตุที่ทำให้ prototype มี AVC สูงมากในหลักสูตรที่มีนิสิตหลักหน่วย)',
      ACTUAL_USAGE: 'แม่นที่สุดแต่ต้องมีข้อมูลการใช้จริงครบทุกหลักสูตร ไม่งั้นจะได้ธง MISSING_DRIVER'
    }
  },
  {
    key: 'depreciation_behavior',
    grp: 'allocation',
    name: 'ประเภทต้นทุนของค่าเสื่อมราคา',
    ...
    impact: {
      ...
      VARIABLE:
        'ค่าเสื่อม 302.5 ลบ. ย้ายไป TVC → TFC : TVC = <b>49.1 : 50.9</b> และ AVC เพิ่มขึ้นราว 6,200 บ./คน ทำให้ Q* ทุกหลักสูตรสูงขึ้น'
    }
  },
  {
    key: 'amount_basis',
    grp: 'allocation',
    name: 'ฐานจำนวนเงินที่ใช้เป็นต้นทุนหลัก',
  ...
  },
  {
    ...
    grp: 'allocation',
    name: 'ส่วนต่างที่ยอมรับได้ในการตรวจยอด (บาท)',
    ...
    affects: false,
    impact: {
      '*': 'ตั้ง 0 บังคับให้ยอดตรงพอดีทุกบาท — ทำได้เพราะเครื่องปันส่วนใช้ largest-remainder แล้ว ถ้าตั้งหลวมกว่านี้จะกลบข้อผิดพลาดจริง'
    }
  },
  {
    key: 'outlier_min_q',
    grp: 'presentation',
    name: 'จำนวนนิสิตขั้นต่ำที่นำขึ้นกราฟ',
    ...
    affects: false,
    impact: {
      '*': 'ที่ค่า 30 คน จะกัน <b>สถาบันวิจัยวลัยรุกขเวช</b> (3 คน · ต้นทุน/หัว 7.8 ลบ.) ออกจากกราฟ — ต้องมีหมายเหตุใต้กราฟเสมอว่ากันอะไรออก'
    }
  },
  {
    key: 'non_academic_unit_in_total',
    grp: 'presentation',
    name: 'นับหน่วยที่ไม่ผลิตบัณฑิตในยอดรวมหรือไม่',
    ...
    impact: {
      ...
      false:
        'ตัดสถาบันวิจัยออกจากยอดรวม — ส่วนเกินเป็น <b>+54.0 ลบ.</b> และ ATC เฉลี่ยลดลง แต่ต้องรายงานหน่วยที่ตัดออกแยกต่างหาก'
    }
  }
]
...
export const SETTING_LOG = [
  {
    t: 'ปีการศึกษา 2568',
    ic: '🎛',
    h: '<b>ยังไม่มีมติ</b> — ทุกค่ายังใช้ค่าเริ่มต้นจากนิยามระบบ · รอมติที่ประชุมกำหนด <code>cm_le_zero_policy</code>, <code>qstar_primary_method</code>, <code>qstar_rounding</code> และ <code>amount_basis</code>'
  },
  {
    t: 'ปีการศึกษา 2567',
    ic: '📌',
    h: '<code>qstar_rounding</code> = <b>round</b> (ตามที่ prototype เดิมคำนวณ) · อนุมัติโดย กองแผนงาน 14 ส.ค. 2568'
  },
  {
    t: 'ปีการศึกษา 2567',
    ic: '📌',
    h: '<code>outlier_min_q</code> = <b>50</b> → เปลี่ยนเป็น <b>30</b> ในปี 2568 เพื่อให้หลักสูตรบัณฑิตศึกษาขนาดเล็กขึ้นกราฟได้'
  },
  {
    t: 'ปีการศึกษา 2566',
    ic: '📌',
    h: '<code>depreciation_behavior</code> = <b>FIXED</b> — ใช้ต่อเนื่องมาตั้งแต่ปีแรกที่มีระบบ'
  }
]
...
export const ROLES = [
  {
    k: 'viewer',
    l: 'ผู้ดูข้อมูล',
    d: 'อธิการบดี · รองอธิการบดี · คณบดี · กรรมการ — ดูอย่างเดียว ไม่แก้อะไรได้',
    scoped: false,
    n: 42
  },
  {
    k: 'faculty_officer',
    l: 'เจ้าหน้าที่คณะ',
    d: 'เห็นเฉพาะหน่วยงานที่ผูกไว้ใน org_unit_id · เสนอข้อมูลของคณะตัวเองได้',
    scoped: true,
    n: 31
  },
  {
    k: 'budget_office',
    l: 'กองแผนงาน',
    d: 'แก้ข้อมูลหลักและเสนออนุมัติได้ทั้งมหาวิทยาลัย · สั่งสร้างรอบคำนวณได้',
    scoped: false,
    n: 6
  },
  {
    k: 'admin',
    l: 'ผู้ดูแลระบบ',
    d: 'อนุมัติทุกอย่าง · ตั้งค่าระบบ · จัดการผู้ใช้และสิทธิ์ · ดู audit log ทั้งหมด',
    scoped: false,
    n: 3
  }
]
...
export const USER_LOG = [
  {
    t: '06 ก.ย. 2569 08:30',
    ic: '🔑',
    h: '<b>ผศ.ดร.ปิยภัทร บุษบาบดินทร์</b> เชิญ <b>นางสาวปาริชาต ดวงแก้ว</b> เข้าใช้ระบบ สิทธิ์ <code>admin</code>'
  },
  {
    t: '01 ก.ย. 2569 15:12',
    ic: '🔄',
    h: 'เปลี่ยนสิทธิ์ <b>นายอัครินทร์ บุพผา</b> จาก <code>faculty_officer</code> เป็น <code>budget_office</code> — ขอบเขตเปลี่ยนจากคณะเดียวเป็นทั้งมหาวิทยาลัย'
  },
  {
    t: '20 ส.ค. 2569 09:00',
    ic: '⏸',
    h: 'ระงับบัญชี <b>นายวิทยา คงเจริญ</b> — ไม่เข้าใช้เกิน 180 วัน (นโยบายความปลอดภัย)'
  },
  {
    t: '11 ก.ค. 2569 14:32',
    ic: '✅',
    h: '<b>ผศ.ดร.ปิยภัทร บุษบาบดินทร์</b> อนุมัติรอบคำนวณ #1042 — เป็นการใช้สิทธิ์อนุมัติที่ถูกบันทึกใน audit log'
  }
]
...
export const ERP_ACCOUNTS = [
  ...
  },
  {
    ...
    exp: '300',
    sub: '30004',
    name: 'ค่าตอบแทนวิทยากรภายนอก (ยกเลิก)',
    from: '2500',
    to: '2567',
    amount: 0,
    ruleKey: null,
...
export const PROGRAM_REG = [
...

  {
    ...
    fac: 'คณะวิศวกรรมศาสตร์',
    lvl: 'ปริญญาตรี',
    deg: 'วศ.บ. วิศวกรรมรถไฟความเร็วสูง',
    intl: false,
    state: 'ACTIVE',
  ...
  {
    code: 'ENG-PRAC-01',
    prog: 'วิศวกรรมปฏิบัติ (ต่อเนื่อง)',
    fac: 'คณะวิศวกรรมศาสตร์',
    lvl: 'ปริญญาตรี',
    deg: 'วศ.บ. วิศวกรรมปฏิบัติ (ต่อเนื่อง)',
    intl: false,
    state: 'ACTIVE',
  ...
  {
    code: 'VET-DVM-01',
    prog: 'สัตวแพทยศาสตรบัณฑิต',
    fac: 'คณะสัตวแพทยศาสตร์',
    lvl: 'ปริญญาตรี',
    deg: 'สัตวแพทยศาสตรบัณฑิต',
    intl: false,
    state: 'ACTIVE',
    vers: [{ v: '2565', from: '2565', to: null, note: '' }]
  },
  ...
  {
    code: 'SCI-AI-BS',
    prog: 'วิทยาการปัญญาประดิษฐ์',
    fac: 'คณะวิทยาศาสตร์',
    lvl: 'ปริญญาตรี',
    deg: 'วท.บ. วิทยาการปัญญาประดิษฐ์',
    intl: false,
  ...
  {
    code: 'ACC-IB-INTL',
    prog: 'ธุรกิจดิจิทัลระหว่างประเทศ (นานาชาติ)',
    fac: 'คณะการบัญชีและการจัดการ',
    lvl: 'ปริญญาตรี',
    deg: 'บธ.บ. ธุรกิจดิจิทัลระหว่างประเทศ',
    intl: true,
    state: 'DRAFT',
    proposedQ: 40,
    by: 'คณะการบัญชีและการจัดการ',
    at: '02 ก.ย. 2569',
  ...
  {
    code: 'HUM-THAI-MA',
    prog: 'ภาษาไทยเพื่ออาชีพ',
    fac: 'คณะมนุษยศาสตร์และสังคมศาสตร์',
    lvl: 'ปริญญาโท',
    deg: 'ศศ.ม. ภาษาไทยเพื่ออาชีพ',
    intl: false,
    state: 'CLOSED',
...
export const PROG_STATE = {
  ...
  REVISING: {
    ...
    c: 'st-run',
    calc: true,
    why: 'รุ่นที่ใช้อยู่ยังคำนวณตามปกติ · รุ่นใหม่มีผลเมื่อถึงปีที่กำหนด'
  },
...
export const PROGRAM_LOG = [
  {
    t: '02 ก.ย. 2569 10:22',
    ic: '➕',
    h: '<b>คณะการบัญชีและการจัดการ</b> สร้างร่างหลักสูตร <b>ธุรกิจดิจิทัลระหว่างประเทศ (นานาชาติ)</b> ประมาณการรับ 40 คน/ปี'
  },
  {
    t: '14 ส.ค. 2569 15:40',
    ic: '📤',
    h: '<b>คณะวิทยาศาสตร์</b> เสนอเปิด <b>วิทยาการปัญญาประดิษฐ์</b> เข้าสภาวิชาการ — แนบผลวิเคราะห์จุดคุ้มทุนจาก W7'
  },
  {
    t: '20 ก.ค. 2569 09:15',
    ic: '🔄',
    h: '<b>คณะนิติศาสตร์</b> สร้างรุ่นปรับปรุง <code>2569</code> ของ <b>นิติศาสตรบัณฑิต</b> — รุ่น <code>2563</code> ยังมีผลจนกว่ารุ่นใหม่จะอนุมัติ'
  },
  {
    t: '11 ก.ค. 2569 11:03',
    ic: '⏸',
    h: '<b>คณะวิทยาศาสตร์</b> ตั้ง <b>เคมี (ปริญญาโท)</b> เป็นงดรับนิสิตปี 2569 — ยังคำนวณต่อเพราะมีนิสิตคงค้าง 1 คน'
  },
  {
    t: '30 มิ.ย. 2569 16:48',
    ic: '⏹',
    h: 'ปิดหลักสูตร <b>ภาษาไทยเพื่ออาชีพ (ปริญญาโท)</b> — ตั้ง <code>valid_to</code> = 2568 ตัวเลขปี 2566–2568 ไม่เปลี่ยนตาม'
  }
]
...
export const ORG_UNITS = [
  ...
  {
    code: 'ACC-UG',
    name: 'คณะการบัญชีและการจัดการ — ปริญญาตรี',
  ...
  {
    code: 'ACC-GR',
    name: 'คณะการบัญชีและการจัดการ — บัณฑิตศึกษา',
    level: 'EDUCATION_LEVEL',
    parent: 'ACC',
    academic: true,
    erp: '0301-2',
  ...
  {
    code: 'SEC-OFF',
    name: 'สำนักงานเลขานุการคณะ (รวมทุกคณะ)',
    level: 'FACULTY',
    parent: 'MSU',
    academic: false,
    erp: 'หลายรหัส',
...
export type StudentType = {
  ...
  share: number
  note: string
  /** ส่วนแบ่งแบบไม่ปัดเศษ — ใช้ตัดสินว่าใครได้เศษที่เหลือ */
  exact: number
  /** จำนวนคนหลังกระจายเศษแล้ว */
  n: number
}
...
export const STUDENT_TYPES: StudentType[] = (() => {
  ...
  const rows: StudentType[] = defs.map(d => ({ ...d, exact: total * d.share, n: Math.floor(total * d.share) }))

  let left = total - rows.reduce((a, d) => a + d.n, 0)
...
/* ---------- import_batch (W9) ----------
   mockup เขียนประวัติ 4 รายการนี้ไว้ใน HTML ของ W9 ตรงๆ (ไม่ได้อยู่ใน master-data.js)
   ย้ายมาไว้ที่นี่ให้อยู่รวมกับ fixture อื่น หน้าจอจะได้อ่านผ่าน src/server/beps/* ทางเดียว */
export const IMPORT_LOG = [
  {
    at: '11 ก.ค. 2569 03:20',
    kind: 'OK' as const,
    text: 'ซิงก์อัตโนมัติ — งบประมาณ 18,432 แถว · ค่าเสื่อมครุภัณฑ์ 9,841 แถว · ผ่านการตรวจทั้งหมด'
  },
  {
    at: '20 พ.ค. 2569 11:47',
    kind: 'FILE' as const,
    text: 'นายอัครินทร์ บุพผา นำเข้าผังบัญชี 4 ระดับ 412 แถว จากไฟล์ coa_2568.xlsx'
  },
  {
    at: '18 พ.ค. 2569 16:02',
    kind: 'FAIL' as const,
    text: 'นำเข้าไม่สำเร็จ — พบหน่วยงาน 3 ชื่อที่ไม่ตรงกับทะเบียนหน่วยงาน ไม่บันทึกทั้งไฟล์'
  },
  {
    at: '14 ส.ค. 2568 09:20',
    kind: 'BATCH' as const,
    text: 'นำเข้าชุดข้อมูลปีงบ 2567 ครบทุกแหล่ง — ใช้เป็นฐานเทียบข้ามปี'
  }
]
