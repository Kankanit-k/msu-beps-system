...
const rowsData: TableBodyRowType[] = [
  {
    avatarSrc: `${process.env.NEXT_PUBLIC_BASEPATH}/images/avatars/1.png`,
  ...
  {
    avatarSrc: `${process.env.NEXT_PUBLIC_BASEPATH}/images/avatars/2.png`,
    name: 'Richard Payne',
  ...
  {
    avatarSrc: `${process.env.NEXT_PUBLIC_BASEPATH}/images/avatars/3.png`,
  ...
  {
    avatarSrc: `${process.env.NEXT_PUBLIC_BASEPATH}/images/avatars/4.png`,
  ...
  {
    avatarSrc: `${process.env.NEXT_PUBLIC_BASEPATH}/images/avatars/5.png`,
  ...
  {
    avatarSrc: `${process.env.NEXT_PUBLIC_BASEPATH}/images/avatars/6.png`,
    name: 'Crystal Mays',
    username: '@crystal99',
  ...
  {
    avatarSrc: `${process.env.NEXT_PUBLIC_BASEPATH}/images/avatars/7.png`,
    name: 'Mary Garcia',
  ...
  {
    avatarSrc: `${process.env.NEXT_PUBLIC_BASEPATH}/images/avatars/8.png`,
    name: 'Megan Roberts',
    username: '@megan78',
