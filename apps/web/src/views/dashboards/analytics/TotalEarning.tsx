...
const data: DataType[] = [
  {
    ...
    imgSrc: `${process.env.NEXT_PUBLIC_BASEPATH}/images/cards/zipcar.png`,
  },
  {
    progress: 50,
    color: 'info',
    ...
    imgSrc: `${process.env.NEXT_PUBLIC_BASEPATH}/images/cards/bitbank.png`,
  },
  {
    progress: 20,
    title: 'Aviato',
    ...
    imgSrc: `${process.env.NEXT_PUBLIC_BASEPATH}/images/cards/aviato.png`,
  },
];
