...
const data: DataType[] = [
  {
    avatarSrc: `${process.env.NEXT_PUBLIC_BASEPATH}/images/logos/mastercard.png`,
    title: 'Credit Card',
    cardNumber: '2566 xxxx xxxx 8908',
    alt: 'master-card',
  },
  {
    avatarSrc: `${process.env.NEXT_PUBLIC_BASEPATH}/images/logos/dinners-club.png`,
    title: 'Credit Card',
      ...
      <CardContent className="flex flex-col gap-3">
        ...
        <div className="p-4 flex gap-4 rounded bg-primaryLight">
          <div className="is-10 bs-10 p-2 rounded border border-primary">
            <img
              src={`${process.env.NEXT_PUBLIC_BASEPATH}/images/cards/briefcase.png`}
              alt="briefcase"
              width={23}
            />
          </div>
